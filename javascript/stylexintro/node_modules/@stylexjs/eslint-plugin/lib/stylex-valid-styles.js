...
var _isStylexCreateVarsToken = _interopRequireDefault(require("./rules/isStylexCreateVarsToken"));
...
const all = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)("initial"), (0, _makeLiteralRule.default)("inherit"), (0, _makeLiteralRule.default)("unset"), (0, _makeLiteralRule.default)("revert"));
...
const transitionProperty = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)("opacity"), (0, _makeLiteralRule.default)("transform"), (0, _makeLiteralRule.default)("opacity, transform"), (0, _makeLiteralRule.default)("none"));
...
const CSSProperties = {
  ...
  all: all,
  animationComposition: (0, _makeUnionRule.default)((0, _makeLiteralRule.default)("replace"), (0, _makeLiteralRule.default)("add"), (0, _makeLiteralRule.default)("accumulate")),
...
const stylexValidStyles = {
  ...
  create(context) {
    ...
    const stylexCreateVarsTokenImports = new Set();
      ...
      if (style.type === "Property") {
        if (style.value.type === "ObjectExpression") {
          ...
          if (keyName.startsWith("@") || keyName.startsWith(":")) {
            if (level === 0) {
              const ruleCheck = (allowOuterPsuedoAndMedia ? allModifiers : pseudoElements)(key, variables);
              if (ruleCheck !== undefined) {
                return context.report({
                  node: style.value,
                  loc: style.value.loc,
                  message: allowOuterPsuedoAndMedia ? "Nested styles can only be used for the pseudo selectors in the stylex allowlist and for @media queries" : "Pseudo Classes, Media Queries and other At Rules should be nested as conditions within style properties. Only Pseudo Elements (::after) are allowed at the top-level"
                });
              }
            } else {
        ...
        const isReferencingStylexCreateVarsTokens = stylexCreateVarsTokenImports.size > 0 && (0, _isStylexCreateVarsToken.default)(style.value, stylexCreateVarsTokenImports);
    ...
    return {
      ...
      ImportDeclaration(node) {
        ...
        const isStylexCreateVarsImport = sourceValue.endsWith(stylexCreateVarsFileExtension);
...
var _default = stylexValidStyles;
